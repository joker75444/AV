...
local Tshake_Msg = database:get(bot_id.."Av:Add:Filter:Rp2"..text..msg.chat_id_)   
if Tshake_Msg then    
...
if text == ("تنزيل مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTshake(msg) then
function Function_Tshake(extra, result, success)
...
if text and text:match("^تنزيل مطور @(.*)$") and DevTshake(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevTshake(msg) then
